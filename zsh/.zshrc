...
zstyle :prompt:pure:git:branch color gree
prompt pure

alias vim="nvim"
alias ty="cd /Users/m11o/silt && vim ./notes/$(TZ=Asia/Tokyo date -v -1d +%Y-%m-%d).md && cd -"
alias t="cd /Users/m11o/silt && vim ./notes/$(TZ=Asia/Tokyo date +%Y-%m-%d).md && cd -"
alias tt="cd /Users/m11o/silt && vim ./notes/$(TZ=Asia/Tokyo date -v +1d +%Y-%m-%d).md && cd -"

# checkout branch searched from fzf
fbr() {
